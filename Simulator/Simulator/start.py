...
# dqn controller
DQNcontroller = DQNController(state_size=1, action_size=3, episode=10, previous_time=4, model='c')
s = simulate(controller=DQNcontroller, sim_time=240, animate=True, parallel=False, name='', selection=1, seed=0, start_time=0, cgm_selection=2, pump_selection=2)
